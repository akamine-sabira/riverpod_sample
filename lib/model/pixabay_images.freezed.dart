...
abstract class $PixabayImageCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String previewURL, String largeImageURL});
}
...
class _$PixabayImageImpl implements _PixabayImage {
  ...
  @override
  String toString() {
    return 'PixabayImage(id: $id, previewURL: $previewURL, largeImageURL: $largeImageURL)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, previewURL, largeImageURL);
